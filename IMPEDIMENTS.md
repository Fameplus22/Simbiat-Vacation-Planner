...
- Status: Pending verification
  ...
  - Impact: Auth UI can be built and checked, but real Supabase draft trip creation, trip detail retrieval, draft editing, itinerary generation, and itinerary detail saving will fail until the `profiles`, `trips`, `trip_cities`, and `trip_days` tables, global planning columns, and draft/itinerary RPCs exist in Supabase.
